...
class IntroViewController: BaseVC, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//        }
    ...
    //MARK: Sign Buttion Press
    
    @IBAction func buttonSignUpPress() {
        self.btnSignUpPress()
    }
}
